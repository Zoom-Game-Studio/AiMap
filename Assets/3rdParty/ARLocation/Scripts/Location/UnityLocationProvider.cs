...
namespace ARLocation
{
    ...
    public class UnityLocationProvider : AbstractLocationProvider
    {
        ...
        protected override LocationReading? ReadLocation()
        {
            ...
            if (AIMapPOICommand.currentLocation == null) return null;
            return new LocationReading()
            {
                latitude = AIMapPOICommand.currentLocation.Latitude,
                longitude = AIMapPOICommand.currentLocation.Longitude,
                altitude = AIMapPOICommand.currentLocation.Altitude,
                accuracy = 0.0,
                floor = -1,
