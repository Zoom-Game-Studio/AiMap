...
namespace NatCorder {
    ...
    public sealed class MP4Recorder : IMediaRecorder {
        ...
        [Doc(@"MP4RecorderCtor")]
        public MP4Recorder (int videoWidth, int videoHeight, int videoFramerate, int audioSampleRate, int audioChannelCount, Action<string> recordingCallback, int videoBitrate = (int)(960 * 540 * 60.0f), int videoKeyframeInterval = 3) {
